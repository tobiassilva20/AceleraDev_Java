...
public class Main {
    public static void main(String[] args) {
        ...
        d.incluirJogador(1L, 1L, "Tobias", LocalDate.parse("1994-11-02"), 1, BigDecimal.valueOf(1000));
        d.incluirJogador(2L, 1L, "Tobias2", LocalDate.parse("1985-11-02"), 2, BigDecimal.valueOf(9000));
